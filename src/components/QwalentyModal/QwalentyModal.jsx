...
export const QuantityModal = ({ isOpen, onClose, onAddToCart, product, selectedColorIndex }) => {
    const [quantity, setQuantity] = useState(1); 
    const [selectedColor, setSelectedColor] = useState(product.colors[selectedColorIndex]);
